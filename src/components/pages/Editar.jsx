...
export const Editar = () => {
  ...
  const conseguirArticulo = async () => {
    ...
    const { datos } = await Peticion(Global.url + 'article/' + params.id, 'GET');
  ...
  const editarArticulo = async (e) => {
    ...
    const { datos } = await Peticion(Global.url + 'article/' + params.id , 'PUT', nuevoArticulo);
  ...
  return (
    <div className='jumbo' >
      ...
      <p>Formulario para editar: { articulo.title }</p>
      ...
      <form className="formulario" onSubmit={ editarArticulo } >
        ...
        <div className='form-group' >
          ...
          <input type="text" name='title' onChange={cambiado} defaultValue={articulo.title} />
        </div>

        <div className='form-group' >
          <label htmlFor='contenido' >Contenido</label>
          <textarea type="text" name='content' onChange={cambiado} defaultValue={articulo.title} />
        </div>
